...
class MS_SSIM_L1_LOSS(nn.Module):
    ...
    def __init__(self, gaussian_sigmas=[0.5, 1.0, 2.0, 4.0, 8.0],
                 ...
                 channel=2):  # RGB image should set to 3 and Gray image should be set to 1
    ...
    def forward(self, x, y):
        ...
        #cross_loss = nn.CrossEntropyLoss(outputs, targets)
        
        loss_mix = self.alpha * loss_ms_ssim + (1 - self.alpha) * gaussian_l1 / self.DR
        #loss_mix = self.alpha * loss_ms_ssim + (1 - self.alpha) * cross_loss
