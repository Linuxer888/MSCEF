...
class MixSoftmaxCrossEntropyLoss(nn.CrossEntropyLoss):
    def __init__(self, aux=True, aux_weight=0.4, ignore_index=-1, **kwargs): # aux_weight=0.2
...
class EncNetLoss(nn.CrossEntropyLoss):
    ...
    def __init__(self, se_loss=True, se_weight=0.2, nclass=2, aux=False,    #hanmh
...
class ICNetLoss(nn.CrossEntropyLoss):
    ...
    def __init__(self, nclass=2, aux_weight=0.4, ignore_index=-1, **kwargs): ##hanmh nclass
...
class OhemCrossEntropy2d(nn.Module):
    def __init__(self, ignore_index=-1, thresh=0.7, min_kept=100000, use_weight=True, **kwargs):
        ...
        if use_weight:
            ...
            '''
            weight = torch.FloatTensor([1,100]) #hanmh
    ...
    def forward(self, pred, target):
        ...
        if self.min_kept > num_valid:
            ...
            #prob = prob.masked_fill_(1 - valid_mask, 1) #hanmh
        ...
        #target = target.masked_fill_(1 - valid_mask, self.ignore_index)  #hanmh
