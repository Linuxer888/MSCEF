...
class _ASPP(nn.Module):
    def __init__(self, in_channels, atrous_rates, norm_layer, norm_kwargs=None, **kwargs): ##xiaoxuan
...
def get_deeplabv3(dataset='pascal_voc', backbone='resnet50', pretrained=False, root='../runs/models',
