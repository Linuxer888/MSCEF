...
class DFANet(nn.Module):
    def __init__(self, nclass, backbone='', aux=False, jpu=False, pretrained_base=False, **kwargs):
        ...
        self.enc2_2 = Enc(240, 48, 4)
        self.enc3_2 = Enc(144, 96, 6)
        self.enc4_2 = Enc(288, 192, 4)
        self.fca_2 = FCAttention(192)

        self.enc2_3 = Enc(240, 48, 4)
        self.enc3_3 = Enc(144, 96, 6)
        self.enc3_4 = Enc(288, 192, 4)
        self.fca_3 = FCAttention(192)

        self.enc2_1_reduce = _ConvBNReLU(48, 32, 1)
        self.enc2_2_reduce = _ConvBNReLU(48, 32, 1)
        self.enc2_3_reduce = _ConvBNReLU(48, 32, 1)
        self.conv_fusion = _ConvBNReLU(32, 32, 1)

        self.fca_1_reduce = _ConvBNReLU(192, 32, 1)
        self.fca_2_reduce = _ConvBNReLU(192, 32, 1)
        self.fca_3_reduce = _ConvBNReLU(192, 32, 1)
    ...
    def forward(self, x):
        ...
        '''
        print(stage1_enc2.shape)
        print(stage1_enc3.shape)
        print(stage1_enc4.shape)
        print(stage1_fca.shape)
        ...
        stage3_fca_decoder = F.interpolate(self.fca_3_reduce(stage3_fca), size=(168,200), #scale_factor=16 xiaoxuan size=(96,168)
                                           mode='bilinear', align_corners=True)
        '''
        print("*****")
        print(fusion.shape)
        print(stage1_fca_decoder.shape)
        print(stage2_fca_decoder.shape)
        print(stage3_fca_decoder.shape)
        '''
