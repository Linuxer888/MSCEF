...
def get_psanet(dataset='pascal_voc', backbone='resnet50', pretrained=False, root='../runs/models',
...
def get_psanet_resnet50_laser(**kwargs):
    return get_psanet('laser', 'resnet50', **kwargs)
