...
def get_psp(dataset='pascal_voc', backbone='resnet50', pretrained=False, root='../runs/models',
...
def get_psp_resnet50_laser(**kwargs):
    return get_psp('laser', 'resnet50', **kwargs)
...
def get_psp_resnet101_laser(**kwargs):
    return get_psp('laser', 'resnet101', **kwargs)
